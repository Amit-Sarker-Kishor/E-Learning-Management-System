...
<html>
<head>
    <title>E_Learning | Multi_Sign In</title>
...
<body>
    ...
    <div class="container-fluid">     
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a style="color: white; font-style: bold;" class="navbar-brand" href="sign_in.php"><big><h1 align=center>Multi User Sign In</h1></big></a>
                <li class="nav-item">
    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <form method="post" class="border shadow p-5 rounded" style="width: 470px;">
                    ...
                    if($_SERVER['REQUEST_METHOD'] == "POST")
                    {
                        ...
                        if(!empty($email) && !empty($password) && !is_numeric($email))
                        {
                            ...
                            else if($role == "student")
                            {
                                ...
                                $_SESSION['merror'] = "Wrong email or password!";
                            }
                            else
                            {
                                //Read from database
                                ...
                                if($result)
                                {
                                    if($result && mysqli_num_rows($result)>0)
                                    {
                                        ...
                                        // Fetching the instructor infrmation (row) and storing to user_data variable
                                        $user_data = mysqli_fetch_assoc($result);

                                        if($user_data['INSTRUCTOR_PASSWORD'] == $password)
                                        {
                                            $_SESSION['t_id'] = $user_data['INSTRUCTOR_ID'];
                        ...
                        else
                        {
                            ...
                            $_SESSION['merror'] = "Please enter valid information!";
                        }
                    }
            ...
            <div class="mb-1">
                <label class="form-label"><b>Select User type:</b>
                </label>
            </div>
